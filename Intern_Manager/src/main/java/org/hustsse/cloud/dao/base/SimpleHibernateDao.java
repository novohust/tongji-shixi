 ...
 */
package org.hustsse.cloud.dao.base;
 ...
 *
 * TODO hql全部放入外部配置文件，用namedQuery方式。
 *
 * @param <T> DAO操作的对象类型
 * @param <PK> 主键类型
 *
...
public class SimpleHibernateDao<T, PK extends Serializable> {
	...
	/**
	 * 按Criteria查询对象列表。应对需要对Criteria做配置的情况，与createCriteria()搭配使用。
	 *
	 * @param c
	 */
	public List<T> find(final Criteria c) {
		return c.list();
	}
	...
	/**
	 * 按Criteria查询唯一对象.应对需要对Criteria做配置的情况，与createCriteria()搭配使用。
	 *
	 * @param c
	 */
	public T findUnique(final Criteria c) {
